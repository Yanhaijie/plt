package com.supermoney.loan.market.encryption;
...
public class RSA {
	 ...
	 * 生成密钥对
	 */
	public static Map<String, String> generateKeyPair(String keywork) throws Exception {
		/*关键字*/
		byte kwb[]=keywork.getBytes();
		/** RSA算法要求有一个可信任的随机数源 */
		SecureRandom sr = StringUtils.isBlank(keywork)? new SecureRandom():new SecureRandom(kwb);
