...
import com.supermoney.loan.mg.dao.SUserAccountBookMapper;
import com.supermoney.loan.mg.dao.SUserAccountMapper;
import com.supermoney.loan.mg.dao.SUserFundMapper;
...
public class UserAccountBussServiceImpl implements UserAccountBussService {
    ...
    public void   freezeOutAccountMoney(Integer bussType,Integer optType,Integer userId,BigDecimal moeny){
        ...
        BigDecimal afterAmount=new BigDecimal(userAccount.getFreezeAmount().toString());
        sUserAccountMapper.updateByPrimaryKey(userAccount);
        ...
        //记录日志
        addAccountLog(userAccount.getAccountId(),userAccount.getUserId(),null,
                bussType,optType,moeny.multiply(new BigDecimal(-1)),afterAmount,"freezeAmount out");
