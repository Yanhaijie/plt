...
public class SMerchantOrder {
    ...
    /**
     * 获取1:商家未接受数据，2：商家已接收数据，3：无数据
     *
     * @return use_status - 1:商家未接受数据，2：商家已接收数据，3：无数据
     */
    ...
    /**
     * 设置1:商家未接受数据，2：商家已接收数据，3：无数据
     *
     * @param useStatus 1:商家未接受数据，2：商家已接收数据，3：无数据
     */
