<template>
  <div>
    ...
    <div class="password-login" @click="signIn">Password login</div>
  </div>
</template>
<script>
  export default {
    ...
    methods: {
      signIn() {
        this.axios.post('http://192.168.0.114:8000/superapi/s/activity/lottery/scrollLotteryList?appSecret=HkQ4OPzsCgvgyU07-Ho03pBeLIcfB79t&access_token=e30a3b5f-ca76-414b-9796-fb4c4edfa5a6');
      },
      // 获取焦点改变placehold提示语
      changePlho() {
